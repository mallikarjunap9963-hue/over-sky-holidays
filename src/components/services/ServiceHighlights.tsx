  ...
  return (
    <section className="relative z-20 -mt-16 mx-auto max-w-[1440px] px-6 lg:px-10">
      <ScrollReveal variant="fade-in-up" duration={1300}>
        <div className="bg-white rounded-2xl shadow-[0_12px_40px_rgba(7,31,67,0.08)] flex flex-wrap lg:flex-nowrap items-center divide-y lg:divide-y-0 lg:divide-x divide-slate-100 py-2">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full border-2 border-blue-50 bg-white">
                    <IconComponent className="w-5 h-5 text-[#0b84d8]" />
                  </div>
                </div>
                <div>
