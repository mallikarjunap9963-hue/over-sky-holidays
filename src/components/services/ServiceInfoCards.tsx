  ...
  return (
    <section className="mx-auto max-w-[1440px] px-6 lg:px-10 mb-20 mt-10">
      <div className="grid lg:grid-cols-2 gap-6 lg:gap-10">
        ...
        {/* Left Card - Documents */}
        <ScrollReveal variant="fade-in-right" duration={1300} className="bg-white rounded-xl shadow-[0_4px_20px_rgba(7,31,67,0.04)] border border-[#bae6fd] p-8 md:p-10 h-full flex flex-col justify-between relative overflow-hidden">
          <div className="relative z-10">
            ...
            <ul className="space-y-3.5">
              {documents.map((doc, index) => (
                ...
                >
                  <Check className="w-[18px] h-[18px] text-[#0b84d8] shrink-0 mt-[2px] stroke-[3]" />
          ...
          <div className="absolute bottom-4 right-4 pointer-events-none z-0">
            <svg
              viewBox="0 0 64 64"
              className="h-24 w-24 text-[#0b84d8] opacity-[0.15]"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
              aria-hidden="true"
        ...
        <ScrollReveal variant="fade-in-left" duration={1300} className="bg-white rounded-xl shadow-[0_4px_20px_rgba(7,31,67,0.04)] border border-[#bae6fd] p-8 md:p-10 h-full">
          <h3 className="text-xl md:text-[22px] font-bold text-[#031d47] mb-6 font-jost">
          ...
          <div className="space-y-5">
            {whyChooseUs.map((item, index) => {
              ...
              return (
                ...
                >
                  <IconComp className="w-5 h-5 text-[#0b84d8] shrink-0 stroke-[2]" />
