      ...
      >
        ...
        <div className="relative mx-auto max-w-[1320px]">
          ...
          <div className="mt-14 grid gap-5 lg:grid-cols-12">
            {/* LEFT LARGE CARD */}
            <article className="group relative min-h-[490px] overflow-hidden rounded-[7px] lg:col-span-3">
              <img
            ...
            {/* RIGHT LARGE CARD */}
            <article className="group relative min-h-[490px] overflow-hidden rounded-[7px] bg-[#fbb03b] lg:col-span-4">
              {/* Top offer area */}
