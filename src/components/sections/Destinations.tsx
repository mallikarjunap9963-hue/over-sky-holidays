          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-12">
            {destinationCards.map((destination) => (
              <a
                ...
                className={`group relative min-h-[300px] overflow-hidden rounded-[24px] shadow-[0_18px_45px_rgba(16,12,8,0.08)] transition duration-500 hover:-translate-y-1 hover:shadow-[0_24px_55px_rgba(16,12,8,0.12)] ${destination.layoutClass}`}
              >
                <img
            ...
            <div className="relative flex min-h-[280px] flex-col items-center justify-center overflow-hidden rounded-[24px] border border-[#bae6fd] bg-gradient-to-br from-[#f0f9ff] via-[#e0f2fe] to-[#bae6fd] px-6 text-center shadow-[0_18px_45px_rgba(16,12,8,0.06)] lg:col-span-4">
