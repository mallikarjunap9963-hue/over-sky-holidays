          ...
          <ScrollReveal variant="fade-in-up" duration={1000}>
            <div className="max-w-[800px]">
              ...
              <nav
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-xl border border-white/15 bg-[#0853a4]/40 px-4 py-2.5 backdrop-blur-md"
              >
                <Link
                  to="/"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-10 shadow-sm border border-slate-100 mb-8">
              ...
              <div className="flex flex-wrap items-center gap-3 border-b border-slate-100 pb-6 mb-8">
                ...
                <button className="h-9 w-9 rounded-full bg-[#f4f7f9] flex items-center justify-center text-[#0853a4] hover:bg-[#0853a4] hover:text-white transition-colors">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6 border border-slate-100 shadow-sm text-center sm:text-left mb-8">
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-center sm:justify-start gap-2">
                  <button className="h-8 w-8 rounded-full bg-[#0853a4] flex items-center justify-center text-white hover:bg-[#100c08] transition-colors"><svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg></button>
                  <button className="h-8 w-8 rounded-full bg-[#100c08] flex items-center justify-center text-white hover:bg-[#0853a4] transition-colors"><svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" /></svg></button>
                  <button className="h-8 w-8 rounded-full bg-[#0853a4] flex items-center justify-center text-white hover:bg-[#100c08] transition-colors"><svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg></button>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="group rounded-[16px] overflow-hidden relative shadow-lg text-center min-h-[400px] flex flex-col justify-center">
              ...
              {/* Gradient Overlays */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#0853a4] via-[#0853a4]/80 to-[#0853a4]/30"></div>
