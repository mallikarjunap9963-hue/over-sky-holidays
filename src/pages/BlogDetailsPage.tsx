          ...
          <ScrollReveal variant="fade-in-up" duration={1000}>
            <div className="max-w-[800px]">
              ...
              <nav
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-4 py-2.5 backdrop-blur-md shadow-sm"
              >
                <Link
                  to="/"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-10 shadow-sm border border-slate-100 mb-8">
              ...
              <div className="flex flex-wrap items-center gap-3 border-b border-slate-100 pb-6 mb-8">
                ...
                <button aria-label="Share on X" className="h-9 w-9 rounded-full bg-[#f4f7f9] flex items-center justify-center text-[#0853a4] hover:bg-[#0853a4] hover:text-white transition-colors cursor-pointer">
                ...
                <button aria-label="Share on Facebook" className="h-9 w-9 rounded-full bg-[#f4f7f9] flex items-center justify-center text-[#0853a4] hover:bg-[#0853a4] hover:text-white transition-colors cursor-pointer">
                ...
                <button aria-label="Share on LinkedIn" className="h-9 w-9 rounded-full bg-[#f4f7f9] flex items-center justify-center text-[#0853a4] hover:bg-[#0853a4] hover:text-white transition-colors cursor-pointer">
                ...
                <button aria-label="Share on WhatsApp" className="h-9 w-9 rounded-full bg-[#f4f7f9] flex items-center justify-center text-[#0853a4] hover:bg-[#0853a4] hover:text-white transition-colors cursor-pointer">
              ...
              <p className="font-jost text-[16px] leading-[1.8] text-slate-600 mb-8 whitespace-pre-line">
                {post.excerpt}
              </p>
              ...
              {post.content && (
                <div
                  ...
                  [&>h2]:before:content-[counter(section)] [&>h2]:before:flex [&>h2]:before:items-center [&>h2]:before:justify-center [&>h2]:before:w-8 [&>h2]:before:h-8 [&>h2]:before:rounded-full [&>h2]:before:bg-[#0853a4] [&>h2]:before:text-white [&>h2]:before:text-[14px] [&>h2]:before:font-bold [&>h2]:[counter-increment:section] [counter-reset:section]"
              ...
              <div className="mt-10 flex justify-center border-t border-slate-100 pt-10">
                <Link to="/blogs" className="flex items-center gap-2 rounded-full border border-[#0853a4] px-8 py-3 text-[14px] font-bold text-[#0853a4] hover:bg-[#0853a4] hover:text-white transition-colors">
                  View All Stories
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6 border border-slate-100 shadow-sm text-center sm:text-left mb-8">
              <img
                src={post.authorImage || "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80"}
                alt={post.author}
                className="h-[90px] w-[90px] rounded-full object-cover shadow-md"
              />
              <div className="flex-1">
                <span className="font-rubik text-[14px] font-bold text-[#0853a4] mb-1 block">About The Author</span>
                ...
                <p className="font-jost text-[14px] text-slate-500 leading-relaxed mb-4">
                  {post.authorDescription || 'Travel enthusiasts sharing honest guides, travel tips, and destination stories to inspire your next adventure.'}
                </p>
                <div className="flex justify-center sm:justify-start gap-2">
                  <a href={post.twitterUrl || "https://x.com/"} target="_blank" rel="noreferrer" className="h-8 w-8 rounded-full bg-[#0853a4] flex items-center justify-center text-white hover:bg-[#100c08] transition-colors"><svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg></a>
                  <a href={post.facebookUrl || "https://www.facebook.com/"} target="_blank" rel="noreferrer" className="h-8 w-8 rounded-full bg-[#100c08] flex items-center justify-center text-white hover:bg-[#0853a4] transition-colors"><svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" /></svg></a>
                  <a href={post.linkedinUrl || "https://www.linkedin.com/"} target="_blank" rel="noreferrer" className="h-8 w-8 rounded-full bg-[#0853a4] flex items-center justify-center text-white hover:bg-[#100c08] transition-colors"><svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg></a>
                </div>
              </div>
            </div>
            ...
            {relatedBlogs.length > 0 && (
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                  {relatedBlogs.map((b) => (
                    <Link key={b.id || b.slug} to={`/blogs/${b.slug || b.id}`} className="group bg-white rounded-[16px] overflow-hidden shadow-sm border border-slate-100 flex flex-col h-full hover:shadow-md transition-shadow">
                      <div className="relative h-[160px] overflow-hidden">
                        <img src={b.imageUrl || b.image} alt={b.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <span className="absolute top-4 left-4 bg-[#0853a4] text-white text-[10px] font-bold px-3 py-1 uppercase rounded-full tracking-wider">
                          {b.category}
                        </span>
                      </div>
                      <div className="p-5 flex flex-col flex-1">
                        ...
                        <h4 className="font-rubik text-[16px] font-bold text-[#100c08] leading-snug group-hover:text-[#0853a4] transition-colors mb-3 line-clamp-2">
                          {b.title}
                        </h4>
                        <div className="mt-auto flex items-center gap-1.5 text-[13px] font-bold text-[#0853a4]">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-white rounded-[16px] p-6 sm:p-8 border border-slate-100 shadow-sm text-center">
              <h3 className="font-rubik text-[18px] font-bold text-[#0853a4] mb-6 relative inline-block">
                About The Author
              ...
              <div className="flex flex-col items-center">
                <img
                  src={post.authorImage || "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80"}
                  alt={post.author}
                  className="h-[100px] w-[100px] rounded-full object-cover shadow-md mb-4"
                />
            ...
            {recentBlogs.length > 0 && (
              <div className="bg-white rounded-[16px] p-6 sm:p-8 border border-slate-100 shadow-sm">
                <h3 className="font-rubik text-[18px] font-bold text-[#0853a4] mb-6">Recent Blogs</h3>
                <div className="space-y-5">
                  {recentBlogs.map((b) => (
                    <Link key={b.id || b.slug} to={`/blogs/${b.slug || b.id}`} className="group flex gap-4 items-center">
                      <img src={b.imageUrl || b.image} alt={b.title} className="min-w-[80px] w-[80px] h-[75px] rounded-[10px] object-cover" />
                      <div>
                        <h4 className="font-rubik text-[14px] font-bold text-[#100c08] leading-tight mb-2 group-hover:text-[#0853a4] transition-colors line-clamp-2">
                          {b.title}
                        </h4>
