                  ...
                  <div>
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div className="relative group">
                          <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#0853a4] transition-colors z-10">
                          ...
                          <input
                            ...
                            className="w-full h-[40px] pl-10 pr-3 rounded-lg border border-slate-200 bg-slate-50/50 text-[#100c08] placeholder:text-slate-500 outline-none focus:border-[#0853a4] focus:bg-white focus:ring-4 focus:ring-[#0853a4]/5 transition-all text-[13.5px]"
                          />
                        </div>
                      ...
                      <div className="relative group">
                        <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#0853a4] transition-colors z-10 pointer-events-none">
                          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        ...
                        <select
                          ...
                          className="w-full h-[40px] pl-10 pr-10 rounded-lg border border-slate-200 bg-slate-50/50 text-[#100c08] outline-none focus:border-[#0853a4] focus:bg-white focus:ring-4 focus:ring-[#0853a4]/5 transition-all text-[13.5px] appearance-none cursor-pointer"
                        >
                      ...
                      <div className="relative group">
                        <span className="absolute left-3.5 top-3 text-slate-400 group-focus-within:text-[#0853a4] transition-colors z-10">
                          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        ...
                        <textarea
                          ...
                          rows={2}
                          className="w-full pl-10 pr-3 py-2 rounded-lg border border-slate-200 bg-slate-50/50 text-[#100c08] placeholder:text-slate-500 outline-none focus:border-[#0853a4] focus:bg-white focus:ring-4 focus:ring-[#0853a4]/5 transition-all text-[13.5px] resize-none text-[13.5px]"
                        />
                      </div>
                      ...
                      <button
                        type="submit"
                        className="w-full h-[42px] rounded-lg bg-[#0853a4] hover:bg-[#064a8f] text-white font-bold text-[14px] flex items-center justify-center gap-2.5 transition duration-300 hover:-translate-y-0.5 active:translate-y-0 shadow-md shadow-[#0853a4]/15 cursor-pointer font-rubik"
                      >
                    ...
                    <div className="mt-5 pt-4 border-t border-slate-100 grid grid-cols-3 gap-2 text-center text-[#100c08] font-rubik">
                      ...
                      <div className="flex flex-col items-center">
                        <svg className="h-4.5 w-4.5 text-[#0853a4] mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <section className="relative w-full">
          <ScrollReveal variant="fade-in-up" delay={200} duration={1300}>
            ...
            <div className="flex items-center justify-center md:justify-start gap-3 bg-white px-6 py-4 border-b border-t border-slate-100/50">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#0853a4]/10 text-[#0853a4] shrink-0">
