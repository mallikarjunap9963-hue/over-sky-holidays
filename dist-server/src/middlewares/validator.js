...
export function validateTourInquiry(req, res, next) {
...
export function validateGeneralEnquiry(req, res, next) {
    const { name, email, phone, travel_date, travelDate, destination, travelers, tour_type, tourType, message, } = req.body;
    const resolvedDate = travel_date || travelDate;
